...
const RelatedPosts: React.FC<RelatedPostsProps> = ({ currentPostId, currentCategoryId }) => {
  ...
  const relatedPosts = useMemo(() => {
    ...
    return [...sameCategoryPosts, ...differentCategoryPosts].slice(0, 8);
  }, [blogPosts, currentPostId, currentCategoryId]);
    ...
    <section className="mt-24 pt-16 border-t border-border">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground">
          Continue reading from our collection of posts.
        </p>
      </motion.div>
